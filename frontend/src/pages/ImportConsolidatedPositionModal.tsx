      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <label className="rounded-md border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
              ...
              <input
                ...
                onChange={(event) => {
                  void modal.selectFile(event.target.files?.[0] ?? null);
                  event.target.value = '';
                }}
              />
            </label>
