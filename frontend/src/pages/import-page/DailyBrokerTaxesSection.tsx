  ...
  return (
    <section className="mt-8 border-t border-slate-200 pt-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <label className="rounded-md bg-slate-700 px-3 py-2 text-sm font-medium text-white hover:bg-slate-600">
          ...
          <input
            ...
            onChange={(event) => {
              void dailyTaxes.importTaxes(event.target.files?.[0] ?? null);
              event.target.value = '';
            }}
          />
        </label>
