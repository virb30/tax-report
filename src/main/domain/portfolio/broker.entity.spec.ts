...
describe('BrokerEntity', () => {
  ...
  it('should restore a broker', () => {
    ...
    const broker = Broker.restore({ id: uuid, name: 'Broker 1', cnpj: new Cnpj('12345678901214'), code: 'xp', active: true });
  ...
  it('should change the cnpj', () => {
    const uuid = Uuid.create();
    const broker = Broker.restore({ id: uuid, name: 'Broker 1', cnpj: new Cnpj('12345678901214'), code: 'BRK1', active: true });
