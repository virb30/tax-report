...
function createElectronApiMock(): ElectronApi {
  return {
    ...
    listMonthlyTaxHistory: jest.fn<ElectronApi['listMonthlyTaxHistory']>(),
    getMonthlyTaxDetail: jest.fn<ElectronApi['getMonthlyTaxDetail']>(),
    recalculateMonthlyTaxHistory: jest.fn<ElectronApi['recalculateMonthlyTaxHistory']>(),
