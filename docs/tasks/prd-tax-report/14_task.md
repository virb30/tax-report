# Tarefa 14.0: v2 - Domínio TaxCompliance (Apuração Mensal, DARF e Prejuízo Acumulado)

<critical>Ler os arquivos de prd.md e techspec.md desta pasta, se você não ler esses arquivos sua tarefa será invalidada</critical>

## Visão Geral

Implementar na v2 o domínio de `TaxCompliance` para apuração mensal por categoria de ativo, compensação de prejuízos acumulados e cálculo de DARF com dedução de IRRF. Esta tarefa depende da conclusão do backlog pré-v2 (até a tarefa 13.0) e amplia o produto com o fluxo fiscal mensal.
...
- [ ] 14.1 Definir entidades e value objects do contexto `TaxCompliance`
- [ ] 14.2 Implementar consolidação mensal por categoria de ativo
- [ ] 14.3 Implementar compensação de prejuízos acumulados por categoria
- [ ] 14.4 Implementar cálculo de DARF com dedução de IRRF
- [ ] 14.5 Implementar regra de isenção para ações abaixo do limite mensal
- [ ] 14.6 Expor DTOs e contratos para consulta de apuração mensal na aplicação
- [ ] 14.7 Criar testes de unidade para lucro, prejuízo, compensação e isenção
- [ ] 14.8 Criar testes de integração para meses encadeados com compensação acumulada
