# Tarefa 12.0: Validação Final do MVP (Relatório, Qualidade e Observabilidade)
...
- Definir explicitamente que DARF e prejuízo acumulado pertencem à tarefa 14.0 (v2)
- Cobrir o fechamento do MVP com testes de integração e E2E
</requirements>

## Subtarefas

- [ ] 12.1 Validar consistência do relatório anual com posição e preço médio persistidos
- [ ] 12.2 Validar classificação por grupo/código e texto de discriminação por ativo
- [ ] 12.3 Consolidar checklist de aceite do MVP com cenários positivos e negativos
- [ ] 12.4 Criar testes de integração do relatório anual com base persistida
- [ ] 12.5 Criar suíte E2E de regressão do fluxo completo do MVP
