# Tarefa 8.0: IPC, Preload Seguro e Fluxos de UI

<critical>Ler os arquivos de prd.md e techspec.md desta pasta, se você não ler esses arquivos sua tarefa será invalidada</critical>

## Visão Geral

Conectar a interface do usuário aos casos de uso por meio de IPC tipado e preload seguro, implementando os fluxos de tela de importação, conferência, gestão de base manual e apuração mensal. Esta tarefa depende da 7.0 e consolida a experiência funcional do usuário no app.
...
- Implementar fluxo de visualização da apuração mensal e DARF
- Cobrir com testes de integração IPC e E2E dos fluxos principais
</requirements>

## Subtarefas

- [ ] 8.1 Implementar handlers IPC para importação, portfolio, tax e report
...
- [ ] 8.5 Integrar tela de apuração mensal/DARF
- [ ] 8.6 Tratar erros de domínio e validação com feedback acionável na UI
- [ ] 8.7 Criar testes de integração dos canais IPC
- [ ] 8.8 Criar testes E2E dos fluxos de UI críticos

## Detalhes de Implementação

Consulte na `techspec.md` as seções **"Fluxo principal de dados"**, **"Endpoints de API"** (IPC), **"Pontos de Integração"** (contextBridge/allowlist), **"Abordagem de Testes"** (E2E) e **"Sequenciamento de Desenvolvimento"** (ordem de construção item 4 e item 7). Consulte no `prd.md` os requisitos RF-01, RF-02, RF-05, RF-10, RF-12 a RF-15 e RF-27.

## Critérios de Sucesso

- Renderer acessa funcionalidades apenas via API segura do preload
- Fluxos de importação, base manual e apuração executam ponta a ponta
