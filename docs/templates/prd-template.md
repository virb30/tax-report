...
[Liste os objetivos específicos e mensuráveis para essa funcionalidade:
...
- Como [tipo do usuário], eu quero [realizar uma ação] para que [benefício]
...
[Capture apenas restrições de considerações de alto nível (**evite soluções de design - essas pertencem à tech Spec**):
