---
description: Run task execution to implements part of a functionality in a complete way
---
...
<critical>Você não pode finalizar a tarefa sem executar o code review, caso ele não passe você deve resolver os problemas e analisar novamente</critical>
<critical>VOCÊ SEMPRE DEVE utilizar a skill code-review para fazer a revisão do código</critical>
